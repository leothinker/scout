  ...
  return (
    <div className="fixed inset-0 bg-background/95 backdrop-blur-md flex items-center justify-center z-50 p-6">
      <Card className="w-full max-w-sm shadow-2xl border-2 border-primary/20">
        <CardHeader>
          <CardTitle className="text-4xl font-black mb-8 text-center bg-gradient-to-br from-primary to-primary/40 bg-clip-text text-transparent italic tracking-tight">
            GAME OVER
          </CardTitle>
        </CardHeader>
